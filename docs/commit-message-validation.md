...
Merge remote-tracking branch 'origin/test-2' into test-2
```
...
Merge commits generated by Git, including `Merge branch 'main' into test-2` and `Merge remote-tracking branch 'origin/test-2' into test-2`, are also allowed.
