...
Provide a reusable React pull request workflow that gates React validation on commit message validation, installs dependencies once, and fans out independent validation jobs.
